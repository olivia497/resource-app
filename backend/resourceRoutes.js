...
// Retrieve All
// creates route at http://localhost:2121/resources
...
function verifyToken(request, response, next) {
  ...
  jwt.verify(token, process.env.SECRET_KEY, (error, user) => {
    ...
    request.body.user = user; // if token validation goes through then we add user to request body in case we want to use it
